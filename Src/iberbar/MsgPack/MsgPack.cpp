...
LUA_API
#endif
luaopen_iberbar_MsgPack( lua_State* pLuaState )
{
	lua_createtable( pLuaState, 2, 0 );
	lua_pushstring( pLuaState, "Encode" );
	lua_pushcfunction( pLuaState, iberbar::MsgPack::LuaCFunction_Encode );
	lua_settable( pLuaState, -3 );

	lua_pushstring( pLuaState, "Decode" );
	lua_pushcfunction( pLuaState, iberbar::MsgPack::LuaCFunction_Decode );
	lua_settable( pLuaState, -3 );
