...
lua_Integer iberbar::Lua::ScriptCallback_ToFunction( lua_State* pLuaState, int nArg )
{
...
lua_Integer iberbar::Lua::ScriptCallback_ToExtParam( lua_State* pLuaState, int nArg )
{
...
bool iberbar::Lua::ScriptCallback_PushFunction( lua_State* pLuaState, lua_Integer nLuaCallback )
{
	lua_pushstring( pLuaState, RefId_Mapping_Function );
	lua_rawget( pLuaState, LUA_REGISTRYINDEX );
...
bool iberbar::Lua::ScriptCallback_PushExtParam( lua_State* pLuaState, lua_Integer nLuaExt )
{
#ifdef _DEBUG
	lua_getglobal( pLuaState, RefId_Mapping_Function_ExtParams );
#else
...
iberbar::Lua::CScriptCallbackHandler::~CScriptCallbackHandler()
{
...
//bool iberbar::Lua::CScriptCallbackHandler::PushFunction() const
//{
